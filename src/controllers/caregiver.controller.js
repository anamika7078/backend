...
// @desc    Get all active caregivers
// @route   GET /api/caregivers/active
// @access  Private
exports.getActiveCaregivers = async (req, res, next) => {
    try {
        const caregivers = await Caregiver.findAll({
            where: {
                status: 'Active',
...
// @desc    Get all available caregivers for family members
// @route   GET /api/caregivers/available
// @access  Private
exports.getAvailableCaregivers = async (req, res, next) => {
    try {
